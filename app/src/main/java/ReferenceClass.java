/**
 * Created by Michael Sharp on 4/20/2015.
 */
public class ReferenceClass {

    /*

    This file is just to provide reference on how the app is supposed to run through the states involved with the app
